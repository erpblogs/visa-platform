...
class SurveySurvey(models.Model):
    ...
    visa_category_ids = fields.One2many('visa.category', 'checklist_survey_id', string='Visa Categories')
    visa_category_count = fields.Integer(compute='_compute_visa_category_count', string='Visa Category Count')
